---
allowed-tools: Bash(git add:*), Bash(git status:*), Bash(git commit:*), Bash(git diff:*), Bash(git log:*), Bash(git push:*), Bash(git branch:*), Bash(git rev-parse:*)
description: Commit and push to remote (no PR)
---
...
- Commit hash + committed files summary
- Push status (branch + remote URL)
