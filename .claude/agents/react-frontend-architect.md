...
When implementing features, always consider the user experience first, followed by code maintainability and performance. Provide clear explanations for architectural decisions and ensure all
code aligns with the established patterns in the @bluelight-hub/frontend package.
