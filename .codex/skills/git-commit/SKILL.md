---
name: git-commit
description: Create Git commits with a strict pre-commit safety check, selective staging, and standardized commit messages. Use when Codex needs to commit repository changes, craft a compliant commit message, or run a safe commit workflow that prevents accidental file inclusion.
---
...
1. Load `/.codex/skills/_shared/commit-conventions.md` before writing the commit message.
2. Apply commit type/context/title rules from that file.
3. Use Codex attribution in the commit footer.
