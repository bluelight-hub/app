...
description: Commit and push changes to remote without creating a PR. Use when Codex should commit and push but skip the pull request step.
---
...
1. Load `/.codex/skills/_shared/commit-conventions.md` before writing commit messages.
