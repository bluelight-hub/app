...
3. **PostgreSQL als Primärdatenbank**: Verwendung von PostgreSQL für Robustheit, Skalierbarkeit und erweiterte Funktionen. Für die lokale Entwicklung wird SQLite weiterhin unterstützt.
