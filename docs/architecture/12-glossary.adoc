...
|Vite
|Modernes Build-Tool für Webanwendungen, das schnelles HMR und optimierte Production-Builds bietet. Wird im Bluelight-Hub-System als Build-Tool für das Frontend verwendet.
|===
