...
=== 6.1 Wichtige Szenarien

==== 6.1.1 Einsatz anlegen und verfolgen
...
==== 6.1.1.1 UI-Transformation bei Einsatzanlage
...
==== 6.1.1.2 UI-Mockups für Verbindungsszenarien
...
==== 6.1.3 Kommunikation über Digitalfunk
...
==== 6.1.4 Verbindungsszenarien

=== 6.2 Anwendungsfälle

==== 6.2.1 Einsatztagebuch (ETB) führen
...
==== 6.3.2 Konfliktlösung bei gleichzeitiger Bearbeitung
...
==== 6.3.3 Einsatz-Erstellung und -Verwaltung
...
==== 6.3.4 ETB (Einsatztagebuch) Kommunikation
...
==== 6.3.5 Health Check Mechanismus
...
==== 6.3.6 Datenbanktransaktionen und Fehlerbehandlung
