...
=== 11.3 Detaillierte Risikobeschreibungen

==== 11.3.1 Synchronisationskonflikte in verschiedenen Verbindungsszenarien (R-1)
...
==== 11.3.2 Datenverlust bei Systemausfall (R-2)
...
==== 11.3.3 Unzuverlässige Verbindung zwischen Client und FüKW (R-9)
...
==== 11.4.1 Bekannte technische Schulden
...
==== 11.4.2 Umgang mit technischen Schulden
...
==== 11.5.3 Inkrementelle Implementierung
