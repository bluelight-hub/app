...
-- AddForeignKey
ALTER TABLE "erinnerungen"
    ADD CONSTRAINT "erinnerungen_parent_erinnerung_id_fkey" FOREIGN KEY ("parent_erinnerung_id") REFERENCES "erinnerungen" ("id") ON DELETE SET NULL ON UPDATE CASCADE;
