...
-- AddForeignKey
ALTER TABLE "befehl" ADD CONSTRAINT "befehl_einsatz_id_fkey" FOREIGN KEY ("einsatz_id") REFERENCES "einsaetze"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "befehl" ADD CONSTRAINT "befehl_ersteller_id_fkey" FOREIGN KEY ("ersteller_id") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "befehl" ADD CONSTRAINT "befehl_original_befehl_id_fkey" FOREIGN KEY ("original_befehl_id") REFERENCES "befehl"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "befehl_empfaenger" ADD CONSTRAINT "befehl_empfaenger_befehl_id_fkey" FOREIGN KEY ("befehl_id") REFERENCES "befehl"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "befehl_kommentar" ADD CONSTRAINT "befehl_kommentar_befehl_id_fkey" FOREIGN KEY ("befehl_id") REFERENCES "befehl"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "befehl_kommentar" ADD CONSTRAINT "befehl_kommentar_author_id_fkey" FOREIGN KEY ("author_id") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "befehl_kommentar" ADD CONSTRAINT "befehl_kommentar_parent_id_fkey" FOREIGN KEY ("parent_id") REFERENCES "befehl_kommentar"("id") ON DELETE SET NULL ON UPDATE CASCADE;
