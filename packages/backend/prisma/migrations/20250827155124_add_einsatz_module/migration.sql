...
ALTER TABLE "public"."einsaetze"
    ADD CONSTRAINT "einsaetze_createdBy_fkey" FOREIGN KEY ("createdBy") REFERENCES "public"."User" ("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."einsaetze"
    ADD CONSTRAINT "einsaetze_updatedBy_fkey" FOREIGN KEY ("updatedBy") REFERENCES "public"."User" ("id") ON DELETE SET NULL ON UPDATE CASCADE;
