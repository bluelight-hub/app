...
-- AddForeignKey
ALTER TABLE "einsatz_rollenzuweisung"
    ADD CONSTRAINT "einsatz_rollenzuweisung_einsatz_id_fkey" FOREIGN KEY ("einsatz_id") REFERENCES "einsaetze" ("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "einsatz_rollenzuweisung"
    ADD CONSTRAINT "einsatz_rollenzuweisung_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "User" ("id") ON DELETE CASCADE ON UPDATE CASCADE;
