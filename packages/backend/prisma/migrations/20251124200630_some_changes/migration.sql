-- AlterTable
ALTER TABLE "einsatztagebuecher"
    ADD COLUMN "nextSequenceNumber" INTEGER      NOT NULL DEFAULT 1,
...
-- AddForeignKey
ALTER TABLE "etb_snapshots"
    ADD CONSTRAINT "etb_snapshots_etbId_fkey" FOREIGN KEY ("etbId") REFERENCES "einsatztagebuecher" ("id") ON DELETE CASCADE ON UPDATE CASCADE;
