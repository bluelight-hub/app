...
ALTER TABLE "invite_codes"
    ADD CONSTRAINT "invite_codes_createdById_fkey" FOREIGN KEY ("createdById") REFERENCES "User" ("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey: ServerAccessToken.inviteCodeId -> InviteCode.id
ALTER TABLE "server_access_tokens"
    ADD CONSTRAINT "server_access_tokens_inviteCodeId_fkey" FOREIGN KEY ("inviteCodeId") REFERENCES "invite_codes" ("id") ON DELETE SET NULL ON UPDATE CASCADE;
