...
-- AddForeignKey
ALTER TABLE "stamm_fahrzeuge"
    ADD CONSTRAINT "stamm_fahrzeuge_fahrzeugtypId_fkey" FOREIGN KEY ("fahrzeugtypId") REFERENCES "fahrzeugtypen" ("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "stamm_fahrzeuge"
    ADD CONSTRAINT "stamm_fahrzeuge_createdBy_fkey" FOREIGN KEY ("createdBy") REFERENCES "User" ("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "stamm_fahrzeuge"
    ADD CONSTRAINT "stamm_fahrzeuge_updatedBy_fkey" FOREIGN KEY ("updatedBy") REFERENCES "User" ("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "stamm_fahrzeuge"
    ADD CONSTRAINT "stamm_fahrzeuge_archivedBy_fkey" FOREIGN KEY ("archivedBy") REFERENCES "User" ("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "stamm_personen"
    ADD CONSTRAINT "stamm_personen_createdBy_fkey" FOREIGN KEY ("createdBy") REFERENCES "User" ("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "stamm_personen"
    ADD CONSTRAINT "stamm_personen_updatedBy_fkey" FOREIGN KEY ("updatedBy") REFERENCES "User" ("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "stamm_personen"
    ADD CONSTRAINT "stamm_personen_archivedBy_fkey" FOREIGN KEY ("archivedBy") REFERENCES "User" ("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "stamm_person_qualifikationen"
    ADD CONSTRAINT "stamm_person_qualifikationen_personId_fkey" FOREIGN KEY ("personId") REFERENCES "stamm_personen" ("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "stamm_person_qualifikationen"
    ADD CONSTRAINT "stamm_person_qualifikationen_qualifikationId_fkey" FOREIGN KEY ("qualifikationId") REFERENCES "qualifikationen" ("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "stamm_person_qualifikationen"
    ADD CONSTRAINT "stamm_person_qualifikationen_createdBy_fkey" FOREIGN KEY ("createdBy") REFERENCES "User" ("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "stamm_person_qualifikationen"
    ADD CONSTRAINT "stamm_person_qualifikationen_updatedBy_fkey" FOREIGN KEY ("updatedBy") REFERENCES "User" ("id") ON DELETE SET NULL ON UPDATE CASCADE;
