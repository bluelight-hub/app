...
ALTER TABLE "erinnerungen"
    ADD CONSTRAINT "erinnerungen_einsatz_id_fkey" FOREIGN KEY ("einsatz_id") REFERENCES "einsaetze" ("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "erinnerungen"
    ADD CONSTRAINT "erinnerungen_erstellt_von_fkey" FOREIGN KEY ("erstellt_von") REFERENCES "User" ("id") ON DELETE RESTRICT ON UPDATE CASCADE;
