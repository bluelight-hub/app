...
ALTER TABLE "kategorien"
    ADD CONSTRAINT "kategorien_einsatz_id_fkey" FOREIGN KEY ("einsatz_id") REFERENCES "einsaetze" ("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "kategorien"
    ADD CONSTRAINT "kategorien_erstellt_von_fkey" FOREIGN KEY ("erstellt_von") REFERENCES "User" ("id") ON DELETE RESTRICT ON UPDATE CASCADE;
