-- AlterTable
ALTER TABLE "befehl" ADD COLUMN     "anonymisiert_am" TIMESTAMP(3),
ADD COLUMN     "deleted_at" TIMESTAMP(3),
ADD COLUMN     "deleted_by" VARCHAR(100),
ADD COLUMN     "is_deleted" BOOLEAN NOT NULL DEFAULT false;

-- AlterTable
ALTER TABLE "befehl_empfaenger" ADD COLUMN     "deleted_at" TIMESTAMP(3),
ADD COLUMN     "deleted_by" VARCHAR(100),
ADD COLUMN     "is_deleted" BOOLEAN NOT NULL DEFAULT false;

-- AlterTable
ALTER TABLE "befehl_kommentar" ADD COLUMN     "deleted_at" TIMESTAMP(3),
ADD COLUMN     "deleted_by" VARCHAR(100),
ADD COLUMN     "is_deleted" BOOLEAN NOT NULL DEFAULT false;
...
-- AddForeignKey
ALTER TABLE "aufbewahrungs_konfiguration" ADD CONSTRAINT "aufbewahrungs_konfiguration_updated_by_fkey" FOREIGN KEY ("updated_by") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "compliance_report" ADD CONSTRAINT "compliance_report_einsatz_id_fkey" FOREIGN KEY ("einsatz_id") REFERENCES "einsaetze"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
