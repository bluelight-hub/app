...
ALTER TABLE "public"."etb_eintraege"
    ADD CONSTRAINT etb_eintraege_seq_chk CHECK ( etb_eintraege."sequenceNumber" > 0 );
ALTER TABLE "public".etb_eintraege
    ADD CONSTRAINT etb_eintraege_version_chk CHECK ( etb_eintraege."version" >= 0 );
...
-- AddForeignKey
ALTER TABLE "public"."einsatztagebuecher"
    ADD CONSTRAINT "einsatztagebuecher_einsatzId_fkey" FOREIGN KEY ("einsatzId") REFERENCES "public"."einsaetze" ("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."einsatztagebuecher"
    ADD CONSTRAINT "einsatztagebuecher_createdBy_fkey" FOREIGN KEY ("createdBy") REFERENCES "public"."User" ("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."einsatztagebuecher"
    ADD CONSTRAINT "einsatztagebuecher_updatedBy_fkey" FOREIGN KEY ("updatedBy") REFERENCES "public"."User" ("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."einsatztagebuecher"
    ADD CONSTRAINT "einsatztagebuecher_lockedBy_fkey" FOREIGN KEY ("lockedBy") REFERENCES "public"."User" ("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."etb_eintraege"
    ADD CONSTRAINT "etb_eintraege_etbId_fkey" FOREIGN KEY ("etbId") REFERENCES "public"."einsatztagebuecher" ("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."etb_eintraege"
    ADD CONSTRAINT "etb_eintraege_createdBy_fkey" FOREIGN KEY ("createdBy") REFERENCES "public"."User" ("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."etb_eintraege"
    ADD CONSTRAINT "etb_eintraege_updatedBy_fkey" FOREIGN KEY ("updatedBy") REFERENCES "public"."User" ("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."etb_eintraege"
    ADD CONSTRAINT "etb_eintraege_deletedBy_fkey" FOREIGN KEY ("deletedBy") REFERENCES "public"."User" ("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."etb_eintrag_historie"
    ADD CONSTRAINT "etb_eintrag_historie_eintragId_fkey" FOREIGN KEY ("eintragId") REFERENCES "public"."etb_eintraege" ("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."etb_eintrag_historie"
    ADD CONSTRAINT "etb_eintrag_historie_changedBy_fkey" FOREIGN KEY ("changedBy") REFERENCES "public"."User" ("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."etb_textbausteine"
    ADD CONSTRAINT "etb_textbausteine_createdBy_fkey" FOREIGN KEY ("createdBy") REFERENCES "public"."User" ("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."etb_textbausteine"
    ADD CONSTRAINT "etb_textbausteine_updatedBy_fkey" FOREIGN KEY ("updatedBy") REFERENCES "public"."User" ("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."etb_archiv"
    ADD CONSTRAINT "etb_archiv_archivedBy_fkey" FOREIGN KEY ("archivedBy") REFERENCES "public"."User" ("id") ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE "public".etb_archiv
    ADD CONSTRAINT etb_archiv_retention_chk CHECK ("aufbewahrungBis" >= "archiveDatum");