...
ALTER TABLE "public"."etb_eintraege" ALTER COLUMN "kategorie" TYPE "public"."EtbKategorie_new" USING ("kategorie"::text::"public"."EtbKategorie_new");
ALTER TABLE "public"."etb_eintrag_historie" ALTER COLUMN "kategorie" TYPE "public"."EtbKategorie_new" USING ("kategorie"::text::"public"."EtbKategorie_new");
ALTER TABLE "public"."etb_textbausteine" ALTER COLUMN "kategorie" TYPE "public"."EtbKategorie_new" USING ("kategorie"::text::"public"."EtbKategorie_new");
