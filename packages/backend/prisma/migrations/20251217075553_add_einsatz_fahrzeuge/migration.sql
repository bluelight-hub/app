...
ALTER TABLE "einsatz_fahrzeuge"
    ADD CONSTRAINT "einsatz_fahrzeuge_einsatz_id_fkey" FOREIGN KEY ("einsatz_id") REFERENCES "einsaetze" ("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "einsatz_fahrzeuge"
    ADD CONSTRAINT "einsatz_fahrzeuge_stamm_id_fkey" FOREIGN KEY ("stamm_id") REFERENCES "stamm_fahrzeuge" ("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "einsatz_fahrzeuge"
    ADD CONSTRAINT "einsatz_fahrzeuge_fahrzeugtyp_id_fkey" FOREIGN KEY ("fahrzeugtyp_id") REFERENCES "fahrzeugtypen" ("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "einsatz_fahrzeuge"
    ADD CONSTRAINT "einsatz_fahrzeuge_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "User" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "einsatz_fahrzeuge"
    ADD CONSTRAINT "einsatz_fahrzeuge_updated_by_fkey" FOREIGN KEY ("updated_by") REFERENCES "User" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
