...
ALTER TABLE "qualifikationen"
    ADD CONSTRAINT "qualifikationen_createdBy_fkey" FOREIGN KEY ("createdBy") REFERENCES "User" ("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "qualifikationen"
    ADD CONSTRAINT "qualifikationen_updatedBy_fkey" FOREIGN KEY ("updatedBy") REFERENCES "User" ("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "fahrzeugtypen"
    ADD CONSTRAINT "fahrzeugtypen_createdBy_fkey" FOREIGN KEY ("createdBy") REFERENCES "User" ("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "fahrzeugtypen"
    ADD CONSTRAINT "fahrzeugtypen_updatedBy_fkey" FOREIGN KEY ("updatedBy") REFERENCES "User" ("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "rollen_definitionen"
    ADD CONSTRAINT "rollen_definitionen_createdBy_fkey" FOREIGN KEY ("createdBy") REFERENCES "User" ("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "rollen_definitionen"
    ADD CONSTRAINT "rollen_definitionen_updatedBy_fkey" FOREIGN KEY ("updatedBy") REFERENCES "User" ("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "rolle_qualifikationen"
    ADD CONSTRAINT "rolle_qualifikationen_rolleId_fkey" FOREIGN KEY ("rolleId") REFERENCES "rollen_definitionen" ("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "rolle_qualifikationen"
    ADD CONSTRAINT "rolle_qualifikationen_qualifikationId_fkey" FOREIGN KEY ("qualifikationId") REFERENCES "qualifikationen" ("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "funk_status_config"
    ADD CONSTRAINT "funk_status_config_createdBy_fkey" FOREIGN KEY ("createdBy") REFERENCES "User" ("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "funk_status_config"
    ADD CONSTRAINT "funk_status_config_updatedBy_fkey" FOREIGN KEY ("updatedBy") REFERENCES "User" ("id") ON DELETE SET NULL ON UPDATE CASCADE;
