...
export abstract class EntityId<TAggregateType extends string> extends ValueObject<EntityIdProps> {
   ...
   * ```
   */
  // eslint-disable-next-line typescript/no-explicit-any -- `this` parameter requires `any` type for subclass polymorphism
  static create<T extends string>(this: any, id?: string): Result<EntityId<T>> {
    ...
    // eslint-disable-next-line -- `this` refers to subclass constructor, not EntityId base class
