 ...
 * 1. Exakt 14 Einträge mit den erwarteten UPPER_SNAKE_CASE-Keys.
 ...
 * 5. Type-Level — alle 14 Werte sind gültige `EventName`-Instanzen.
 */
describe('EVENT_NAMES.EIGENSCHUTZ (Story 1.7 AC2)', () => {
  ...
  it('(1) enthält genau 14 Einträge mit den erwarteten UPPER_SNAKE_CASE-Keys', () => {
  ...
  it('(5) alle 14 Werte sind gültige EventName-Instanzen (Type-Level)', () => {
    const values = Object.values(EVENT_NAMES.EIGENSCHUTZ);
