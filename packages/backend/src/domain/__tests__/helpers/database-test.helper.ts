/**
 * Database Test Helpers für Domain Layer Integration Tests.
 *
 ...
 *
 * **Architektur Note:**
 * Diese Datei ist eine Kopie des Infrastructure Helpers für Domain Layer Tests.
 * Domain Layer Tests dürfen NICHT von Infrastructure Layer importieren,
 * daher ist diese Duplizierung notwendig für Architektur-Konformität.
 *
 * **Verwendung:**
 * ```typescript
 * describe('MyAggregate - Integration Tests', () => {
 *   beforeAll(async () => {
