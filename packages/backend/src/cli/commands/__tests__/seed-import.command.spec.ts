...
describe('SeedImportCommand', () => {
    ...
    describe('run', () => {
        ...
        it('sollte Dry-Run-Modus verwenden', async () => {
            ...
            expect(loggerSpy).toHaveBeenCalledWith('🔍 Dry-Run-Modus: Keine Datenbank-Änderungen werden vorgenommen');
        });
    ...
    describe('showExampleFiles', () => {
        ...
        it('sollte Warnung bei fehlenden Beispiel-Dateien anzeigen', async () => {
            ...
            expect(loggerWarnSpy).toHaveBeenCalledWith('⚠️  Keine Beispiel-Dateien im Verzeichnis seed-data/examples gefunden.');
        });
        ...
        it('sollte Fehler beim Lesen des Verzeichnisses behandeln', async () => {
            ...
            expect(loggerErrorSpy).toHaveBeenCalledWith(`❌ Fehler beim Lesen des Beispiel-Verzeichnisses: ${error.message}`);
        });
        ...
        it('sollte Parse-Fehler bei ungültigen JSON-Dateien behandeln', async () => {
            ...
            expect(loggerErrorSpy).toHaveBeenCalledWith(expect.stringContaining('❌ Fehler beim Lesen der Datei:'));
        });
    });
