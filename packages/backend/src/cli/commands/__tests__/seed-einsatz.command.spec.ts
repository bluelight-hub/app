...
describe('SeedEinsatzCommand', () => {
  ...
  describe('run', () => {
    it('sollte einen Einsatz mit default name erstellen wenn kein name angegeben', async () => {
      ...
      jest
        .spyOn(command as any, 'generateDefaultName')
        .mockReturnValue('Test-Einsatz 2025-05-25 13:45');
      ...
      expect(mockLogger).toHaveBeenCalledWith(
        'Erstelle benutzerdefinierten Einsatz "Test-Einsatz 2025-05-25 13:45"...',
      );
      expect(mockLogger).toHaveBeenCalledWith(
    ...
    it('sollte einen Einsatz mit angegebenem name erstellen', async () => {
      ...
      expect(mockLogger).toHaveBeenCalledWith(
        `Erstelle benutzerdefinierten Einsatz "${customName}"...`,
      );
    });
    ...
    it('sollte P2002 Fehler (unique constraint) korrekt behandeln', async () => {
      ...
      expect(errorLogSpy).toHaveBeenCalledWith('Ein Einsatz mit diesem Namen existiert bereits');
    });
