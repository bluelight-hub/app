/**
 * Infrastructure Event Adapter für Lagekarte Event Handling.
 *
 ...
 * - Application Layer (LagekarteAutoCreationHandler): Pure TypeScript, Framework-agnostisch
 ...
 * @see LagekarteAutoCreationHandler - Application Layer Implementation
 * @see EVENT_HANDLER.LAGEKARTE_AUTO_CREATION - DI Token
 */
...
/**
 * NestJS Event Adapter für Lagekarte Auto-Creation.
 *
 ...
 */
@Injectable()
export class LagekarteEventAdapter {
  constructor(
    @Inject(EVENT_HANDLER.LAGEKARTE_AUTO_CREATION)
