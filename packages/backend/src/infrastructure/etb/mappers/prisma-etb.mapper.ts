...
import type { Einsatztagebuch, EtbEintrag as PrismaEtbEintrag, EtbKategorie as PrismaEtbKategorie, EtbStatus as PrismaEtbStatus } from '@/generated/prisma/client';
...
export class PrismaEtbMapper {
  ...
  private static getNextSequenceNumber(aggregate: EinsatztagebuchAggregate): number {
    ...
    // eslint-disable-next-line typescript/no-explicit-any -- Mapper benoetigt Zugriff auf private field
