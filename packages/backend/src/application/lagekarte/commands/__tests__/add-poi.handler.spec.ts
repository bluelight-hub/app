...
describe('AddPoiCommandHandler', () => {
  ...
  describe('Success Cases', () => {
    it('should add POI with Lat/Lng coordinate and convert to MGRS', async () => {
      ...
      const command = new AddPoiCommand(lagekarteId, 'Brandenburger Tor', { lat: 52.5163, lng: 13.3777 }, 'EINSATZSTELLE');
    ...
    it('should add POI with MGRS string used directly', async () => {
      // Given
      const lagekarteId = createValidTestId('lagekarte');
      const command = new AddPoiCommand(lagekarteId, 'Rathaus Hamburg', { mgrs: '32UNE8934004990' }, 'BEREITSTELLUNGSRAUM');
    ...
    it('should add POI with optional beschreibung', async () => {
      // Given
      const lagekarteId = createValidTestId('lagekarte');
      const command = new AddPoiCommand(lagekarteId, 'Gefahrenstelle', { lat: 52.5163, lng: 13.3777 }, 'GEFAHRENSTELLE', 'Überflutete Straße, nicht befahrbar');
  ...
  describe('Failure Cases - LagekarteId validation', () => {
    it('should fail when LagekarteId format is invalid', async () => {
      ...
      const command = new AddPoiCommand(invalidLagekarteId, 'Test POI', { lat: 52.5163, lng: 13.3777 }, 'EINSATZSTELLE');
  ...
  describe('Failure Cases - Invalid coordinates', () => {
    it('should fail when MGRS string is invalid', async () => {
      // Given
      const lagekarteId = createValidTestId('lagekarte');
      const command = new AddPoiCommand(lagekarteId, 'Invalid POI', { mgrs: 'INVALID_MGRS_STRING' }, 'EINSATZSTELLE');
    ...
    it('should fail when latitude is out of range (> 90)', async () => {
      // Given
      const lagekarteId = createValidTestId('lagekarte');
      const command = new AddPoiCommand(lagekarteId, 'Invalid Latitude', { lat: 91, lng: 13.3777 }, 'EINSATZSTELLE');
    ...
    it('should fail when longitude is out of range (> 180)', async () => {
      // Given
      const lagekarteId = createValidTestId('lagekarte');
      const command = new AddPoiCommand(lagekarteId, 'Invalid Longitude', { lat: 52.5163, lng: 181 }, 'EINSATZSTELLE');
  ...
  describe('Failure Cases - Invalid POI category', () => {
    it('should fail when category is invalid', async () => {
      // Given
      const lagekarteId = createValidTestId('lagekarte');
      const command = new AddPoiCommand(lagekarteId, 'Test POI', { lat: 52.5163, lng: 13.3777 }, 'INVALID_CATEGORY');
  ...
  describe('Failure Cases - Aggregate business rule violations', () => {
    it('should fail when duplicate POI name exists in aggregate', async () => {
      // Given
      const lagekarteId = createValidTestId('lagekarte');
      const command = new AddPoiCommand(lagekarteId, 'Duplicate POI', { lat: 52.5163, lng: 13.3777 }, 'EINSATZSTELLE');
  ...
  describe('Edge Cases', () => {
    it('should handle lagekarteId with all valid nanoid characters', async () => {
      ...
      const command = new AddPoiCommand(complexLagekarteId, 'Test POI', { lat: 52.5163, lng: 13.3777 }, 'EINSATZSTELLE');
    ...
    it('should handle POI at northern Germany boundary (Flensburg)', async () => {
      ...
      const lagekarteId = createValidTestId('lagekarte');
      const command = new AddPoiCommand(lagekarteId, 'Flensburg North', { lat: 54.78, lng: 9.44 }, 'SONSTIGES');
    ...
    it('should handle POI at southern Germany boundary (Munich)', async () => {
      ...
      const lagekarteId = createValidTestId('lagekarte');
      const command = new AddPoiCommand(lagekarteId, 'Munich Marienplatz', { lat: 48.1371, lng: 11.5754 }, 'SONSTIGES');
