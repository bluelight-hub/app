  ...
  describe('Fire-and-Forget Resilience', () => {
    ...
    it('should log warning but continue processing when funkrufname is undefined', async () => {
      ...
      const corruptedEvent = new FmsStatusGeaendertEvent(
        ...
        // eslint-disable-next-line typescript/no-explicit-any -- Test validates handling of corrupted event data
    ...
    it('should handle edge case with null neuerStatus gracefully', async () => {
      ...
      const corruptedEvent = new FmsStatusGeaendertEvent(
        ...
        2, // previousStatus
        // eslint-disable-next-line typescript/no-explicit-any -- Test validates handling of corrupted event data with null status
    ...
    it('should reject invalid status code 10 (above maximum)', async () => {
      ...
      const corruptedEvent = new FmsStatusGeaendertEvent(
        ...
        // eslint-disable-next-line typescript/no-explicit-any -- Test validates rejection of invalid status code above maximum
    ...
    it('should reject invalid status code -1 (below minimum)', async () => {
      ...
      const corruptedEvent = new FmsStatusGeaendertEvent(
        ...
        generateTestUuid(),
        'Florian 1/46',
        // eslint-disable-next-line typescript/no-explicit-any -- Test validates rejection of invalid status code below minimum
    ...
    it('should reject NaN status code', async () => {
      ...
      const corruptedEvent = new FmsStatusGeaendertEvent(
        ...
        'Florian 1/46',
        2, // previousStatus: valid
        // eslint-disable-next-line typescript/no-explicit-any -- Test validates rejection of NaN as invalid status code
