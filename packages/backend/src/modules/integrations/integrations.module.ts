...
import { AdminHiOrgIntegrationController, AdminIntegrationsController } from '@/modules/integrations/controllers';
...
@Module({
  ...
  controllers: [AdminHiOrgIntegrationController, AdminIntegrationsController, OAuthCallbackController],
  providers: [
