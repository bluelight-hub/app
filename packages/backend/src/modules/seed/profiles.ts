...
export const DRK_SEED_PROFILES: Record<string, SeedProfile> = {
  manv: {
    ...
    einsatz: {
      ...
      beschreibung:
        'Zugunglück mit 25 Verletzten, Aufbau Behandlungsplatz und Patientenverteilung. Sichtung nach STaRT-Algorithmus, Einrichtung von 3 Behandlungsplätzen (rot/gelb/grün), Koordination mit Rettungsleitstelle.',
    },
    metadata: {
  ...
  sanitaetsdienst: {
    ...
    einsatz: {
      ...
      beschreibung:
        'Medizinische Betreuung beim Stadtfest mit 10.000 Besuchern. Aufbau Sanitätszelt, Bereitstellung von Sanitätspersonal, Behandlung kleinerer Verletzungen und Kreislaufprobleme.',
    },
    metadata: {
  ...
  katastrophenschutz: {
    ...
    einsatz: {
      ...
      beschreibung:
        'Evakuierung und Betreuung bei Hochwasserlage, 200 betroffene Personen. Einrichtung Notunterkunft, Verpflegung, medizinische Grundversorgung, Koordination mit Feuerwehr und THW.',
    },
    metadata: {
  ...
  betreuung: {
    ...
    einsatz: {
      ...
      beschreibung:
        'Einrichtung und Betrieb einer Notunterkunft für 150 Personen nach Hausbrand. Versorgung mit Nahrung, Kleidung, psychosoziale Betreuung, Vermisstensuche.',
    },
    metadata: {
  ...
  rettungsdienst: {
    ...
    einsatz: {
      ...
      beschreibung:
        'Schwerer Verkehrsunfall A9, 3 Verletzte, Notarzt angefordert. Eine Person eingeklemmt, technische Rettung erforderlich, Schockraumvoranmeldung für 2 Patienten.',
    },
    metadata: {
  ...
  psnv: {
    ...
    einsatz: {
      ...
      beschreibung:
        'Psychosoziale Betreuung nach schwerem Schulunfall, 30 betroffene Schüler und Lehrer. Akute Belastungsreaktionen, Krisenintervention, Angehörigenbetreuung.',
    },
    metadata: {
  ...
  ausbildung: {
    ...
    einsatz: {
      ...
      beschreibung:
        'Großübung MANV-Szenario mit 15 Statisten als Verletzte. Übung der Sichtung, Behandlungsplatz-Aufbau und Zusammenarbeit mit anderen Hilfsorganisationen.',
    },
    metadata: {
