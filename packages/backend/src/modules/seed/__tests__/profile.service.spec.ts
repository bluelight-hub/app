...
describe('ProfileService', () => {
    ...
    describe('getProfilesByCategory', () => {
        it('sollte Profile nach Kategorie filtern', () => {
            ...
            expect(result).toEqual(mockProfiles);
            expect(ProfileUtils.getProfilesByCategory).toHaveBeenCalledWith(DRKEinsatzCategory.RETTUNGSDIENST);
        });
    });
    ...
    describe('getRecommendedProfiles', () => {
        ...
        it('sollte nach Kategorie filtern', () => {
            const result = service.getRecommendedProfiles({ category: DRKEinsatzCategory.RETTUNGSDIENST });

            expect(result).toEqual([mockProfile]);

            const resultFiltered = service.getRecommendedProfiles({ category: DRKEinsatzCategory.KATASTROPHENSCHUTZ });
            expect(resultFiltered).toEqual([]);
        });
