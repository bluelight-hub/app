...
describe('ErrorHandlingService', () => {
  ...
  describe('executeWithErrorHandling', () => {
    it('sollte Operation erfolgreich ausführen', async () => {
      ...
      const result = await service.executeWithErrorHandling(mockOperation, 'test-operation', {
        test: 'data',
      });
  ...
  describe('Error Handling Paths', () => {
    ...
    it('sollte Operation ohne Advanced Retry ausführen', async () => {
      ...
      const result = await noRetryService.executeWithErrorHandling(mockOperation, 'no-retry-test');
