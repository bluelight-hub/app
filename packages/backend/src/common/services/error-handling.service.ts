...
export class ErrorHandlingService {
    ...
    private loadFeatureFlags(): ErrorHandlingFeatureFlags {
        return {
            enableAdvancedRetry: this.configService.get('ERROR_HANDLING_ENABLE_ADVANCED_RETRY',
                DEFAULT_FEATURE_FLAGS.enableAdvancedRetry),
            enableDuplicateDetection: this.configService.get('ERROR_HANDLING_ENABLE_DUPLICATE_DETECTION',
                DEFAULT_FEATURE_FLAGS.enableDuplicateDetection),
            enableMetricsCollection: this.configService.get('ERROR_HANDLING_ENABLE_METRICS',
                DEFAULT_FEATURE_FLAGS.enableMetricsCollection),
            enableCircuitBreaker: this.configService.get('ERROR_HANDLING_ENABLE_CIRCUIT_BREAKER',
                DEFAULT_FEATURE_FLAGS.enableCircuitBreaker),
            enableRateLimiting: this.configService.get('ERROR_HANDLING_ENABLE_RATE_LIMITING',
    ...
    getMetrics(): ErrorMetrics {
        return {
            ...this.metrics,
            averageRetryAttempts: this.metrics.totalErrors > 0
