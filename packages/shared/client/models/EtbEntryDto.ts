...
export function instanceOfEtbEntryDto(value: object): value is EtbEntryDto {
  ...
  if (!('laufendeNummer' in value) || value['laufendeNummer'] === undefined) return false;
  if (!('timestampErstellung' in value) || value['timestampErstellung'] === undefined) return false;
  ...
  if (!('autorRolle' in value) || value['autorRolle'] === undefined) return false;
  if (!('kategorie' in value) || value['kategorie'] === undefined) return false;
  if (!('inhalt' in value) || value['inhalt'] === undefined) return false;
  if (!('referenzEinsatzId' in value) || value['referenzEinsatzId'] === undefined) return false;
  if (!('referenzPatientId' in value) || value['referenzPatientId'] === undefined) return false;
  if (!('referenzEinsatzmittelId' in value) || value['referenzEinsatzmittelId'] === undefined)
    return false;
  if (!('systemQuelle' in value) || value['systemQuelle'] === undefined) return false;
  if (!('version' in value) || value['version'] === undefined) return false;
  if (!('istAbgeschlossen' in value) || value['istAbgeschlossen'] === undefined) return false;
  if (!('timestampAbschluss' in value) || value['timestampAbschluss'] === undefined) return false;
  if (!('abgeschlossenVon' in value) || value['abgeschlossenVon'] === undefined) return false;
...
export function EtbEntryDtoFromJSONTyped(json: any, ignoreDiscriminator: boolean): EtbEntryDto {
  if (json == null) {
    return json;
  }
  return {
    ...
    timestampAbschluss:
      json['timestampAbschluss'] == null ? null : new Date(json['timestampAbschluss']),
