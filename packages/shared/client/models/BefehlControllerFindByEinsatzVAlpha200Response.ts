 ...
 * 
 * @export
 * @interface BefehlControllerFindByEinsatzVAlpha200Response
 */
export interface BefehlControllerFindByEinsatzVAlpha200Response {
    /**
     * 
     * @type {Array<BefehlDto>}
     * @memberof BefehlControllerFindByEinsatzVAlpha200Response
     */
    data: Array<BefehlDto>;
    /**
     * 
...
/**
 * Check if a given object implements the BefehlControllerFindByEinsatzVAlpha200Response interface.
 */
export function instanceOfBefehlControllerFindByEinsatzVAlpha200Response(value: object): value is BefehlControllerFindByEinsatzVAlpha200Response {
    if (!('data' in value) || value['data'] === undefined) return false;
    if (!('meta' in value) || value['meta'] === undefined) return false;
    return true;
}

export function BefehlControllerFindByEinsatzVAlpha200ResponseFromJSON(json: any): BefehlControllerFindByEinsatzVAlpha200Response {
    return BefehlControllerFindByEinsatzVAlpha200ResponseFromJSONTyped(json, false);
}

export function BefehlControllerFindByEinsatzVAlpha200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): BefehlControllerFindByEinsatzVAlpha200Response {
    if (json == null) {
        return json;
    }
    return {
        
        'data': ((json['data'] as Array<any>).map(BefehlDtoFromJSON)),
...
export function BefehlControllerFindByEinsatzVAlpha200ResponseToJSON(json: any): BefehlControllerFindByEinsatzVAlpha200Response {
    return BefehlControllerFindByEinsatzVAlpha200ResponseToJSONTyped(json, false);
}

export function BefehlControllerFindByEinsatzVAlpha200ResponseToJSONTyped(value?: BefehlControllerFindByEinsatzVAlpha200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': ((value['data'] as Array<any>).map(BefehlDtoToJSON)),
