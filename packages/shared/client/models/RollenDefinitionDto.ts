...
export interface RollenDefinitionDto {
     ...
     * @type {Array<ErforderlicheQualifikationDto>}
     * @memberof RollenDefinitionDto
     */
    erforderlicheQualifikationen: Array<ErforderlicheQualifikationDto>;
    /**
     * Erstellungsdatum
     * @type {Date}
     * @memberof RollenDefinitionDto
...
export function RollenDefinitionDtoFromJSONTyped(json: any, ignoreDiscriminator: boolean): RollenDefinitionDto {
    ...
    return {
        ...
        'erforderlicheQualifikationen': ((json['erforderlicheQualifikationen'] as Array<any>).map(ErforderlicheQualifikationDtoFromJSON)),
...
export function RollenDefinitionDtoToJSONTyped(value?: RollenDefinitionDto | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'erforderlicheQualifikationen': ((value['erforderlicheQualifikationen'] as Array<any>).map(ErforderlicheQualifikationDtoToJSON)),
