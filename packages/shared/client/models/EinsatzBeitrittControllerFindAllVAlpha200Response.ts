 ...
 * 
 * @export
 * @interface EinsatzBeitrittControllerFindAllVAlpha200Response
 */
export interface EinsatzBeitrittControllerFindAllVAlpha200Response {
    /**
     * 
     * @type {Array<BeitrittsanfrageResponseDto>}
     * @memberof EinsatzBeitrittControllerFindAllVAlpha200Response
     */
    data: Array<BeitrittsanfrageResponseDto>;
    /**
     * 
...
/**
 * Check if a given object implements the EinsatzBeitrittControllerFindAllVAlpha200Response interface.
 */
export function instanceOfEinsatzBeitrittControllerFindAllVAlpha200Response(value: object): value is EinsatzBeitrittControllerFindAllVAlpha200Response {
    if (!('data' in value) || value['data'] === undefined) return false;
    if (!('meta' in value) || value['meta'] === undefined) return false;
    return true;
}

export function EinsatzBeitrittControllerFindAllVAlpha200ResponseFromJSON(json: any): EinsatzBeitrittControllerFindAllVAlpha200Response {
    return EinsatzBeitrittControllerFindAllVAlpha200ResponseFromJSONTyped(json, false);
}

export function EinsatzBeitrittControllerFindAllVAlpha200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): EinsatzBeitrittControllerFindAllVAlpha200Response {
    if (json == null) {
        return json;
    }
    return {
        
        'data': ((json['data'] as Array<any>).map(BeitrittsanfrageResponseDtoFromJSON)),
...
export function EinsatzBeitrittControllerFindAllVAlpha200ResponseToJSON(json: any): EinsatzBeitrittControllerFindAllVAlpha200Response {
    return EinsatzBeitrittControllerFindAllVAlpha200ResponseToJSONTyped(json, false);
}

export function EinsatzBeitrittControllerFindAllVAlpha200ResponseToJSONTyped(value?: EinsatzBeitrittControllerFindAllVAlpha200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': ((value['data'] as Array<any>).map(BeitrittsanfrageResponseDtoToJSON)),
