 ...
 * 
 * @export
 * @interface AlarmierungControllerListVAlpha200Response
 */
export interface AlarmierungControllerListVAlpha200Response {
    /**
     * 
     * @type {Array<AlarmierungResponseDto>}
     * @memberof AlarmierungControllerListVAlpha200Response
     */
    data: Array<AlarmierungResponseDto>;
    /**
     * 
...
/**
 * Check if a given object implements the AlarmierungControllerListVAlpha200Response interface.
 */
export function instanceOfAlarmierungControllerListVAlpha200Response(value: object): value is AlarmierungControllerListVAlpha200Response {
    if (!('data' in value) || value['data'] === undefined) return false;
    if (!('meta' in value) || value['meta'] === undefined) return false;
    return true;
}

export function AlarmierungControllerListVAlpha200ResponseFromJSON(json: any): AlarmierungControllerListVAlpha200Response {
    return AlarmierungControllerListVAlpha200ResponseFromJSONTyped(json, false);
}

export function AlarmierungControllerListVAlpha200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): AlarmierungControllerListVAlpha200Response {
    if (json == null) {
        return json;
    }
    return {
        
        'data': ((json['data'] as Array<any>).map(AlarmierungResponseDtoFromJSON)),
...
export function AlarmierungControllerListVAlpha200ResponseToJSON(json: any): AlarmierungControllerListVAlpha200Response {
    return AlarmierungControllerListVAlpha200ResponseToJSONTyped(json, false);
}

export function AlarmierungControllerListVAlpha200ResponseToJSONTyped(value?: AlarmierungControllerListVAlpha200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': ((value['data'] as Array<any>).map(AlarmierungResponseDtoToJSON)),
