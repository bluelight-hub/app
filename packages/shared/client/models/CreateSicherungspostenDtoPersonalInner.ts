...
import {
    ...
    CreateSicherungspostenPersonalFreitextDtoFromJSON,
...
export function CreateSicherungspostenDtoPersonalInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateSicherungspostenDtoPersonalInner {
    if (json == null) {
        return json;
    }
...
export function CreateSicherungspostenDtoPersonalInnerToJSON(json: any): any {
    return CreateSicherungspostenDtoPersonalInnerToJSONTyped(json, false);
}

export function CreateSicherungspostenDtoPersonalInnerToJSONTyped(value?: CreateSicherungspostenDtoPersonalInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
