 ...
 * 
 * @export
 * @interface UserManagementControllerGetUserPermissionsVAlpha200Response
 */
export interface UserManagementControllerGetUserPermissionsVAlpha200Response {
    /**
     * 
     * @type {Array<UserPermissionDto>}
     * @memberof UserManagementControllerGetUserPermissionsVAlpha200Response
     */
    data: Array<UserPermissionDto>;
    /**
     * 
...
/**
 * Check if a given object implements the UserManagementControllerGetUserPermissionsVAlpha200Response interface.
 */
export function instanceOfUserManagementControllerGetUserPermissionsVAlpha200Response(value: object): value is UserManagementControllerGetUserPermissionsVAlpha200Response {
    if (!('data' in value) || value['data'] === undefined) return false;
    if (!('meta' in value) || value['meta'] === undefined) return false;
    return true;
}

export function UserManagementControllerGetUserPermissionsVAlpha200ResponseFromJSON(json: any): UserManagementControllerGetUserPermissionsVAlpha200Response {
    return UserManagementControllerGetUserPermissionsVAlpha200ResponseFromJSONTyped(json, false);
}

export function UserManagementControllerGetUserPermissionsVAlpha200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): UserManagementControllerGetUserPermissionsVAlpha200Response {
    if (json == null) {
        return json;
    }
    return {
        
        'data': ((json['data'] as Array<any>).map(UserPermissionDtoFromJSON)),
...
export function UserManagementControllerGetUserPermissionsVAlpha200ResponseToJSON(json: any): UserManagementControllerGetUserPermissionsVAlpha200Response {
    return UserManagementControllerGetUserPermissionsVAlpha200ResponseToJSONTyped(json, false);
}

export function UserManagementControllerGetUserPermissionsVAlpha200ResponseToJSONTyped(value?: UserManagementControllerGetUserPermissionsVAlpha200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': ((value['data'] as Array<any>).map(UserPermissionDtoToJSON)),
