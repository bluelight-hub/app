 ...
 * 
 * @export
 * @interface TaktischeZeichenControllerFindAllVAlpha200Response
 */
export interface TaktischeZeichenControllerFindAllVAlpha200Response {
    /**
     * 
     * @type {Array<TaktischesZeichenResponseDto>}
     * @memberof TaktischeZeichenControllerFindAllVAlpha200Response
     */
    data: Array<TaktischesZeichenResponseDto>;
    /**
     * 
...
/**
 * Check if a given object implements the TaktischeZeichenControllerFindAllVAlpha200Response interface.
 */
export function instanceOfTaktischeZeichenControllerFindAllVAlpha200Response(value: object): value is TaktischeZeichenControllerFindAllVAlpha200Response {
    if (!('data' in value) || value['data'] === undefined) return false;
    if (!('meta' in value) || value['meta'] === undefined) return false;
    return true;
}

export function TaktischeZeichenControllerFindAllVAlpha200ResponseFromJSON(json: any): TaktischeZeichenControllerFindAllVAlpha200Response {
    return TaktischeZeichenControllerFindAllVAlpha200ResponseFromJSONTyped(json, false);
}

export function TaktischeZeichenControllerFindAllVAlpha200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): TaktischeZeichenControllerFindAllVAlpha200Response {
    if (json == null) {
        return json;
    }
    return {
        
        'data': ((json['data'] as Array<any>).map(TaktischesZeichenResponseDtoFromJSON)),
...
export function TaktischeZeichenControllerFindAllVAlpha200ResponseToJSON(json: any): TaktischeZeichenControllerFindAllVAlpha200Response {
    return TaktischeZeichenControllerFindAllVAlpha200ResponseToJSONTyped(json, false);
}

export function TaktischeZeichenControllerFindAllVAlpha200ResponseToJSONTyped(value?: TaktischeZeichenControllerFindAllVAlpha200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': ((value['data'] as Array<any>).map(TaktischesZeichenResponseDtoToJSON)),
