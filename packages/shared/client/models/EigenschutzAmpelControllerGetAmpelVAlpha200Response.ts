...
import type { AmpelProjectionDto } from './AmpelProjectionDto';
import {
    AmpelProjectionDtoFromJSON,
    AmpelProjectionDtoFromJSONTyped,
    AmpelProjectionDtoToJSON,
    AmpelProjectionDtoToJSONTyped,
} from './AmpelProjectionDto';
 ...
 * 
 * @export
 * @interface EigenschutzAmpelControllerGetAmpelVAlpha200Response
 */
export interface EigenschutzAmpelControllerGetAmpelVAlpha200Response {
    /**
     * 
     * @type {Array<AmpelProjectionDto>}
     * @memberof EigenschutzAmpelControllerGetAmpelVAlpha200Response
     */
    data: Array<AmpelProjectionDto>;
    /**
     * 
...
/**
 * Check if a given object implements the EigenschutzAmpelControllerGetAmpelVAlpha200Response interface.
 */
export function instanceOfEigenschutzAmpelControllerGetAmpelVAlpha200Response(value: object): value is EigenschutzAmpelControllerGetAmpelVAlpha200Response {
    if (!('data' in value) || value['data'] === undefined) return false;
    if (!('meta' in value) || value['meta'] === undefined) return false;
    return true;
}

export function EigenschutzAmpelControllerGetAmpelVAlpha200ResponseFromJSON(json: any): EigenschutzAmpelControllerGetAmpelVAlpha200Response {
    return EigenschutzAmpelControllerGetAmpelVAlpha200ResponseFromJSONTyped(json, false);
}

export function EigenschutzAmpelControllerGetAmpelVAlpha200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): EigenschutzAmpelControllerGetAmpelVAlpha200Response {
    if (json == null) {
        return json;
    }
    return {
        
        'data': ((json['data'] as Array<any>).map(AmpelProjectionDtoFromJSON)),
...
export function EigenschutzAmpelControllerGetAmpelVAlpha200ResponseToJSON(json: any): EigenschutzAmpelControllerGetAmpelVAlpha200Response {
    return EigenschutzAmpelControllerGetAmpelVAlpha200ResponseToJSONTyped(json, false);
}

export function EigenschutzAmpelControllerGetAmpelVAlpha200ResponseToJSONTyped(value?: EigenschutzAmpelControllerGetAmpelVAlpha200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': ((value['data'] as Array<any>).map(AmpelProjectionDtoToJSON)),
