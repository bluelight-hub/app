...
import type { ComplianceReportDto } from './ComplianceReportDto';
import {
    ComplianceReportDtoFromJSON,
    ComplianceReportDtoFromJSONTyped,
    ComplianceReportDtoToJSON,
    ComplianceReportDtoToJSONTyped,
} from './ComplianceReportDto';
 ...
 * 
 * @export
 * @interface AufbewahrungControllerGetReportsVAlpha200Response
 */
export interface AufbewahrungControllerGetReportsVAlpha200Response {
    /**
     * 
     * @type {Array<ComplianceReportDto>}
     * @memberof AufbewahrungControllerGetReportsVAlpha200Response
     */
    data: Array<ComplianceReportDto>;
    /**
     * 
...
/**
 * Check if a given object implements the AufbewahrungControllerGetReportsVAlpha200Response interface.
 */
export function instanceOfAufbewahrungControllerGetReportsVAlpha200Response(value: object): value is AufbewahrungControllerGetReportsVAlpha200Response {
    if (!('data' in value) || value['data'] === undefined) return false;
    if (!('meta' in value) || value['meta'] === undefined) return false;
    return true;
}

export function AufbewahrungControllerGetReportsVAlpha200ResponseFromJSON(json: any): AufbewahrungControllerGetReportsVAlpha200Response {
    return AufbewahrungControllerGetReportsVAlpha200ResponseFromJSONTyped(json, false);
}

export function AufbewahrungControllerGetReportsVAlpha200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): AufbewahrungControllerGetReportsVAlpha200Response {
    if (json == null) {
        return json;
    }
    return {
        
        'data': ((json['data'] as Array<any>).map(ComplianceReportDtoFromJSON)),
...
export function AufbewahrungControllerGetReportsVAlpha200ResponseToJSON(json: any): AufbewahrungControllerGetReportsVAlpha200Response {
    return AufbewahrungControllerGetReportsVAlpha200ResponseToJSONTyped(json, false);
}

export function AufbewahrungControllerGetReportsVAlpha200ResponseToJSONTyped(value?: AufbewahrungControllerGetReportsVAlpha200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': ((value['data'] as Array<any>).map(ComplianceReportDtoToJSON)),
