...
import type { AlarmierungTimelineEventDto } from './AlarmierungTimelineEventDto';
import {
    AlarmierungTimelineEventDtoFromJSON,
    AlarmierungTimelineEventDtoFromJSONTyped,
    AlarmierungTimelineEventDtoToJSON,
    AlarmierungTimelineEventDtoToJSONTyped,
} from './AlarmierungTimelineEventDto';
 ...
 * 
 * @export
 * @interface AlarmierungControllerTimelineVAlpha200Response
 */
export interface AlarmierungControllerTimelineVAlpha200Response {
    /**
     * 
     * @type {Array<AlarmierungTimelineEventDto>}
     * @memberof AlarmierungControllerTimelineVAlpha200Response
     */
    data: Array<AlarmierungTimelineEventDto>;
    /**
     * 
...
/**
 * Check if a given object implements the AlarmierungControllerTimelineVAlpha200Response interface.
 */
export function instanceOfAlarmierungControllerTimelineVAlpha200Response(value: object): value is AlarmierungControllerTimelineVAlpha200Response {
    if (!('data' in value) || value['data'] === undefined) return false;
    if (!('meta' in value) || value['meta'] === undefined) return false;
    return true;
}

export function AlarmierungControllerTimelineVAlpha200ResponseFromJSON(json: any): AlarmierungControllerTimelineVAlpha200Response {
    return AlarmierungControllerTimelineVAlpha200ResponseFromJSONTyped(json, false);
}

export function AlarmierungControllerTimelineVAlpha200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): AlarmierungControllerTimelineVAlpha200Response {
    if (json == null) {
        return json;
    }
    return {
        
        'data': ((json['data'] as Array<any>).map(AlarmierungTimelineEventDtoFromJSON)),
...
export function AlarmierungControllerTimelineVAlpha200ResponseToJSON(json: any): AlarmierungControllerTimelineVAlpha200Response {
    return AlarmierungControllerTimelineVAlpha200ResponseToJSONTyped(json, false);
}

export function AlarmierungControllerTimelineVAlpha200ResponseToJSONTyped(value?: AlarmierungControllerTimelineVAlpha200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': ((value['data'] as Array<any>).map(AlarmierungTimelineEventDtoToJSON)),
