...
export function AdminHiOrgIntegrationControllerAutoMatchQualifikationenVAlpha200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): AdminHiOrgIntegrationControllerAutoMatchQualifikationenVAlpha200Response {
    if (json == null) {
        return json;
    }
    return {
...
export function AdminHiOrgIntegrationControllerAutoMatchQualifikationenVAlpha200ResponseToJSONTyped(value?: AdminHiOrgIntegrationControllerAutoMatchQualifikationenVAlpha200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
