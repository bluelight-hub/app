 ...
 * 
 * @export
 * @interface TaktischeZeichenControllerGetDefaultsFahrzeugtypenVAlpha200Response
 */
export interface TaktischeZeichenControllerGetDefaultsFahrzeugtypenVAlpha200Response {
    /**
     * 
     * @type {Array<DefaultZeichenResponseDto>}
     * @memberof TaktischeZeichenControllerGetDefaultsFahrzeugtypenVAlpha200Response
     */
    data: Array<DefaultZeichenResponseDto>;
    /**
     * 
...
/**
 * Check if a given object implements the TaktischeZeichenControllerGetDefaultsFahrzeugtypenVAlpha200Response interface.
 */
export function instanceOfTaktischeZeichenControllerGetDefaultsFahrzeugtypenVAlpha200Response(value: object): value is TaktischeZeichenControllerGetDefaultsFahrzeugtypenVAlpha200Response {
    if (!('data' in value) || value['data'] === undefined) return false;
    if (!('meta' in value) || value['meta'] === undefined) return false;
    return true;
}

export function TaktischeZeichenControllerGetDefaultsFahrzeugtypenVAlpha200ResponseFromJSON(json: any): TaktischeZeichenControllerGetDefaultsFahrzeugtypenVAlpha200Response {
    return TaktischeZeichenControllerGetDefaultsFahrzeugtypenVAlpha200ResponseFromJSONTyped(json, false);
}

export function TaktischeZeichenControllerGetDefaultsFahrzeugtypenVAlpha200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): TaktischeZeichenControllerGetDefaultsFahrzeugtypenVAlpha200Response {
    if (json == null) {
        return json;
    }
    return {
        
        'data': ((json['data'] as Array<any>).map(DefaultZeichenResponseDtoFromJSON)),
...
export function TaktischeZeichenControllerGetDefaultsFahrzeugtypenVAlpha200ResponseToJSON(json: any): TaktischeZeichenControllerGetDefaultsFahrzeugtypenVAlpha200Response {
    return TaktischeZeichenControllerGetDefaultsFahrzeugtypenVAlpha200ResponseToJSONTyped(json, false);
}

export function TaktischeZeichenControllerGetDefaultsFahrzeugtypenVAlpha200ResponseToJSONTyped(value?: TaktischeZeichenControllerGetDefaultsFahrzeugtypenVAlpha200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': ((value['data'] as Array<any>).map(DefaultZeichenResponseDtoToJSON)),
