 ...
 * 
 * @export
 * @interface SicherheitsregelControllerListRegelnVAlpha200Response
 */
export interface SicherheitsregelControllerListRegelnVAlpha200Response {
    /**
     * 
     * @type {Array<SicherheitsregelDto>}
     * @memberof SicherheitsregelControllerListRegelnVAlpha200Response
     */
    data: Array<SicherheitsregelDto>;
    /**
     * 
...
/**
 * Check if a given object implements the SicherheitsregelControllerListRegelnVAlpha200Response interface.
 */
export function instanceOfSicherheitsregelControllerListRegelnVAlpha200Response(value: object): value is SicherheitsregelControllerListRegelnVAlpha200Response {
    if (!('data' in value) || value['data'] === undefined) return false;
    if (!('meta' in value) || value['meta'] === undefined) return false;
    return true;
}

export function SicherheitsregelControllerListRegelnVAlpha200ResponseFromJSON(json: any): SicherheitsregelControllerListRegelnVAlpha200Response {
    return SicherheitsregelControllerListRegelnVAlpha200ResponseFromJSONTyped(json, false);
}

export function SicherheitsregelControllerListRegelnVAlpha200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): SicherheitsregelControllerListRegelnVAlpha200Response {
    if (json == null) {
        return json;
    }
    return {
        
        'data': ((json['data'] as Array<any>).map(SicherheitsregelDtoFromJSON)),
...
export function SicherheitsregelControllerListRegelnVAlpha200ResponseToJSON(json: any): SicherheitsregelControllerListRegelnVAlpha200Response {
    return SicherheitsregelControllerListRegelnVAlpha200ResponseToJSONTyped(json, false);
}

export function SicherheitsregelControllerListRegelnVAlpha200ResponseToJSONTyped(value?: SicherheitsregelControllerListRegelnVAlpha200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': ((value['data'] as Array<any>).map(SicherheitsregelDtoToJSON)),
