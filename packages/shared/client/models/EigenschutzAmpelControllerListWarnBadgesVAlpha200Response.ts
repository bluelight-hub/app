...
import type { AmpelWarnBadgeDto } from './AmpelWarnBadgeDto';
import {
    AmpelWarnBadgeDtoFromJSON,
    AmpelWarnBadgeDtoFromJSONTyped,
    AmpelWarnBadgeDtoToJSON,
    AmpelWarnBadgeDtoToJSONTyped,
} from './AmpelWarnBadgeDto';
 ...
 * 
 * @export
 * @interface EigenschutzAmpelControllerListWarnBadgesVAlpha200Response
 */
export interface EigenschutzAmpelControllerListWarnBadgesVAlpha200Response {
    /**
     * 
     * @type {Array<AmpelWarnBadgeDto>}
     * @memberof EigenschutzAmpelControllerListWarnBadgesVAlpha200Response
     */
    data: Array<AmpelWarnBadgeDto>;
    /**
     * 
...
/**
 * Check if a given object implements the EigenschutzAmpelControllerListWarnBadgesVAlpha200Response interface.
 */
export function instanceOfEigenschutzAmpelControllerListWarnBadgesVAlpha200Response(value: object): value is EigenschutzAmpelControllerListWarnBadgesVAlpha200Response {
    if (!('data' in value) || value['data'] === undefined) return false;
    if (!('meta' in value) || value['meta'] === undefined) return false;
    return true;
}

export function EigenschutzAmpelControllerListWarnBadgesVAlpha200ResponseFromJSON(json: any): EigenschutzAmpelControllerListWarnBadgesVAlpha200Response {
    return EigenschutzAmpelControllerListWarnBadgesVAlpha200ResponseFromJSONTyped(json, false);
}

export function EigenschutzAmpelControllerListWarnBadgesVAlpha200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): EigenschutzAmpelControllerListWarnBadgesVAlpha200Response {
    if (json == null) {
        return json;
    }
    return {
        
        'data': ((json['data'] as Array<any>).map(AmpelWarnBadgeDtoFromJSON)),
...
export function EigenschutzAmpelControllerListWarnBadgesVAlpha200ResponseToJSON(json: any): EigenschutzAmpelControllerListWarnBadgesVAlpha200Response {
    return EigenschutzAmpelControllerListWarnBadgesVAlpha200ResponseToJSONTyped(json, false);
}

export function EigenschutzAmpelControllerListWarnBadgesVAlpha200ResponseToJSONTyped(value?: EigenschutzAmpelControllerListWarnBadgesVAlpha200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': ((value['data'] as Array<any>).map(AmpelWarnBadgeDtoToJSON)),
