...
import type { AddEintragDtoKontext } from './AddEintragDtoKontext';
import {
    AddEintragDtoKontextFromJSON,
    AddEintragDtoKontextFromJSONTyped,
    AddEintragDtoKontextToJSON,
    AddEintragDtoKontextToJSONTyped,
} from './AddEintragDtoKontext';
...
export interface AddEintragDto {
    ...
    occurredAt?: string;
    /**
     * Fachlicher Ereignis-Zeitstempel (Default: Erstellungszeitpunkt)
     * @type {string}
     * @memberof AddEintragDto
     */
     ...
     * @memberof AddEintragDto
     */
    kontext?: AddEintragDtoKontext | null;
}
...
export function AddEintragDtoFromJSONTyped(json: any, ignoreDiscriminator: boolean): AddEintragDto {
    ...
    return {
        ...
        'ereignisZeitpunkt': json['ereignisZeitpunkt'] == null ? undefined : json['ereignisZeitpunkt'],
        'kontext': json['kontext'] == null ? undefined : AddEintragDtoKontextFromJSON(json['kontext']),
    };
}
...
export function AddEintragDtoToJSONTyped(value?: AddEintragDto | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'ereignisZeitpunkt': value['ereignisZeitpunkt'],
        'kontext': AddEintragDtoKontextToJSON(value['kontext']),
    };
}
