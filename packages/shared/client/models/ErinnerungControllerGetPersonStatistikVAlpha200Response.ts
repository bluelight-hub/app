...
import { PersonStatistikDtoFromJSON, PersonStatistikDtoFromJSONTyped, PersonStatistikDtoToJSON, PersonStatistikDtoToJSONTyped } from './PersonStatistikDto';

/**
 *
 * @export
 * @interface ErinnerungControllerGetPersonStatistikVAlpha200Response
 */
export interface ErinnerungControllerGetPersonStatistikVAlpha200Response {
  /**
   *
   * @type {PersonStatistikDto}
...
/**
 * Check if a given object implements the ErinnerungControllerGetPersonStatistikVAlpha200Response interface.
 */
...
export function ErinnerungControllerGetPersonStatistikVAlpha200ResponseFromJSON(json: any): ErinnerungControllerGetPersonStatistikVAlpha200Response {
  return ErinnerungControllerGetPersonStatistikVAlpha200ResponseFromJSONTyped(json, false);
}

export function ErinnerungControllerGetPersonStatistikVAlpha200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ErinnerungControllerGetPersonStatistikVAlpha200Response {
  if (json == null) {
    return json;
  }
  return {
...
export function ErinnerungControllerGetPersonStatistikVAlpha200ResponseToJSON(json: any): ErinnerungControllerGetPersonStatistikVAlpha200Response {
  return ErinnerungControllerGetPersonStatistikVAlpha200ResponseToJSONTyped(json, false);
}

export function ErinnerungControllerGetPersonStatistikVAlpha200ResponseToJSONTyped(value?: ErinnerungControllerGetPersonStatistikVAlpha200Response | null, ignoreDiscriminator: boolean = false): any {
  if (value == null) {
    return value;
  }
