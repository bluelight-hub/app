 ...
 *
 * @export
 * @interface NotizControllerGetByEinsatzVAlpha200Response
 */
export interface NotizControllerGetByEinsatzVAlpha200Response {
  /**
   *
   * @type {Array<NotizResponseDto>}
   * @memberof NotizControllerGetByEinsatzVAlpha200Response
   */
  data: Array<NotizResponseDto>;
  /**
   *
...
/**
 * Check if a given object implements the NotizControllerGetByEinsatzVAlpha200Response interface.
 */
export function instanceOfNotizControllerGetByEinsatzVAlpha200Response(value: object): value is NotizControllerGetByEinsatzVAlpha200Response {
  if (!('data' in value) || value['data'] === undefined) return false;
  if (!('meta' in value) || value['meta'] === undefined) return false;
  return true;
}

export function NotizControllerGetByEinsatzVAlpha200ResponseFromJSON(json: any): NotizControllerGetByEinsatzVAlpha200Response {
  return NotizControllerGetByEinsatzVAlpha200ResponseFromJSONTyped(json, false);
}

export function NotizControllerGetByEinsatzVAlpha200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): NotizControllerGetByEinsatzVAlpha200Response {
  if (json == null) {
    return json;
  }
  return {
    data: (json['data'] as Array<any>).map(NotizResponseDtoFromJSON),
...
export function NotizControllerGetByEinsatzVAlpha200ResponseToJSON(json: any): NotizControllerGetByEinsatzVAlpha200Response {
  return NotizControllerGetByEinsatzVAlpha200ResponseToJSONTyped(json, false);
}

export function NotizControllerGetByEinsatzVAlpha200ResponseToJSONTyped(value?: NotizControllerGetByEinsatzVAlpha200Response | null, ignoreDiscriminator: boolean = false): any {
  if (value == null) {
    return value;
  }

  return {
    data: (value['data'] as Array<any>).map(NotizResponseDtoToJSON),
