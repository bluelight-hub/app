 ...
 * 
 * @export
 * @interface SicherungspostenControllerListSicherungspostenVAlpha200Response
 */
export interface SicherungspostenControllerListSicherungspostenVAlpha200Response {
    /**
     * 
     * @type {Array<SicherungspostenDto>}
     * @memberof SicherungspostenControllerListSicherungspostenVAlpha200Response
     */
    data: Array<SicherungspostenDto>;
    /**
     * 
...
/**
 * Check if a given object implements the SicherungspostenControllerListSicherungspostenVAlpha200Response interface.
 */
export function instanceOfSicherungspostenControllerListSicherungspostenVAlpha200Response(value: object): value is SicherungspostenControllerListSicherungspostenVAlpha200Response {
    if (!('data' in value) || value['data'] === undefined) return false;
    if (!('meta' in value) || value['meta'] === undefined) return false;
    return true;
}

export function SicherungspostenControllerListSicherungspostenVAlpha200ResponseFromJSON(json: any): SicherungspostenControllerListSicherungspostenVAlpha200Response {
    return SicherungspostenControllerListSicherungspostenVAlpha200ResponseFromJSONTyped(json, false);
}

export function SicherungspostenControllerListSicherungspostenVAlpha200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): SicherungspostenControllerListSicherungspostenVAlpha200Response {
    if (json == null) {
        return json;
    }
    return {
        
        'data': ((json['data'] as Array<any>).map(SicherungspostenDtoFromJSON)),
...
export function SicherungspostenControllerListSicherungspostenVAlpha200ResponseToJSON(json: any): SicherungspostenControllerListSicherungspostenVAlpha200Response {
    return SicherungspostenControllerListSicherungspostenVAlpha200ResponseToJSONTyped(json, false);
}

export function SicherungspostenControllerListSicherungspostenVAlpha200ResponseToJSONTyped(value?: SicherungspostenControllerListSicherungspostenVAlpha200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': ((value['data'] as Array<any>).map(SicherungspostenDtoToJSON)),
