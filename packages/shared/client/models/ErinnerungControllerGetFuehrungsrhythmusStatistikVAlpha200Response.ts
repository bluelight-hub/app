 ...
 * 
 * @export
 * @interface ErinnerungControllerGetFuehrungsrhythmusStatistikVAlpha200Response
 */
export interface ErinnerungControllerGetFuehrungsrhythmusStatistikVAlpha200Response {
    /**
     * 
     * @type {FuehrungsrhythmusStatistikDto}
     * @memberof ErinnerungControllerGetFuehrungsrhythmusStatistikVAlpha200Response
     */
    data: FuehrungsrhythmusStatistikDto;
    /**
     * 
...
/**
 * Check if a given object implements the ErinnerungControllerGetFuehrungsrhythmusStatistikVAlpha200Response interface.
 */
...
export function ErinnerungControllerGetFuehrungsrhythmusStatistikVAlpha200ResponseFromJSON(json: any): ErinnerungControllerGetFuehrungsrhythmusStatistikVAlpha200Response {
    return ErinnerungControllerGetFuehrungsrhythmusStatistikVAlpha200ResponseFromJSONTyped(json, false);
}

export function ErinnerungControllerGetFuehrungsrhythmusStatistikVAlpha200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ErinnerungControllerGetFuehrungsrhythmusStatistikVAlpha200Response {
    if (json == null) {
        return json;
    }
    return {
        
        'data': FuehrungsrhythmusStatistikDtoFromJSON(json['data']),
        'meta': HealthControllerGetIntegrationHealth200ResponseMetaFromJSON(json['meta']),
    };
}

export function ErinnerungControllerGetFuehrungsrhythmusStatistikVAlpha200ResponseToJSON(json: any): ErinnerungControllerGetFuehrungsrhythmusStatistikVAlpha200Response {
    return ErinnerungControllerGetFuehrungsrhythmusStatistikVAlpha200ResponseToJSONTyped(json, false);
}

export function ErinnerungControllerGetFuehrungsrhythmusStatistikVAlpha200ResponseToJSONTyped(value?: ErinnerungControllerGetFuehrungsrhythmusStatistikVAlpha200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': FuehrungsrhythmusStatistikDtoToJSON(value['data']),
