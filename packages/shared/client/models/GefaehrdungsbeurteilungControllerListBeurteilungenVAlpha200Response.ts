 ...
 * 
 * @export
 * @interface GefaehrdungsbeurteilungControllerListBeurteilungenVAlpha200Response
 */
export interface GefaehrdungsbeurteilungControllerListBeurteilungenVAlpha200Response {
    /**
     * 
     * @type {Array<GefaehrdungsbeurteilungDto>}
     * @memberof GefaehrdungsbeurteilungControllerListBeurteilungenVAlpha200Response
     */
    data: Array<GefaehrdungsbeurteilungDto>;
    /**
     * 
...
/**
 * Check if a given object implements the GefaehrdungsbeurteilungControllerListBeurteilungenVAlpha200Response interface.
 */
export function instanceOfGefaehrdungsbeurteilungControllerListBeurteilungenVAlpha200Response(value: object): value is GefaehrdungsbeurteilungControllerListBeurteilungenVAlpha200Response {
    if (!('data' in value) || value['data'] === undefined) return false;
    if (!('meta' in value) || value['meta'] === undefined) return false;
    return true;
}

export function GefaehrdungsbeurteilungControllerListBeurteilungenVAlpha200ResponseFromJSON(json: any): GefaehrdungsbeurteilungControllerListBeurteilungenVAlpha200Response {
    return GefaehrdungsbeurteilungControllerListBeurteilungenVAlpha200ResponseFromJSONTyped(json, false);
}

export function GefaehrdungsbeurteilungControllerListBeurteilungenVAlpha200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GefaehrdungsbeurteilungControllerListBeurteilungenVAlpha200Response {
    if (json == null) {
        return json;
    }
    return {
        
        'data': ((json['data'] as Array<any>).map(GefaehrdungsbeurteilungDtoFromJSON)),
...
export function GefaehrdungsbeurteilungControllerListBeurteilungenVAlpha200ResponseToJSON(json: any): GefaehrdungsbeurteilungControllerListBeurteilungenVAlpha200Response {
    return GefaehrdungsbeurteilungControllerListBeurteilungenVAlpha200ResponseToJSONTyped(json, false);
}

export function GefaehrdungsbeurteilungControllerListBeurteilungenVAlpha200ResponseToJSONTyped(value?: GefaehrdungsbeurteilungControllerListBeurteilungenVAlpha200Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': ((value['data'] as Array<any>).map(GefaehrdungsbeurteilungDtoToJSON)),
