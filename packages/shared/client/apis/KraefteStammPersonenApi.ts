...
export class KraefteStammPersonenApi extends runtime.BaseAPI {
     ...
     */
    async stammPersonenControllerFindAllVAlphaRaw(requestParameters: StammPersonenControllerFindAllVAlphaRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AdminStammPersonenControllerFindAllVAlpha200Response>> {
     ...
     * Alle StammPersonen auflisten
     */
    async stammPersonenControllerFindAllVAlpha(requestParameters: StammPersonenControllerFindAllVAlphaRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<AdminStammPersonenControllerFindAllVAlpha200Response> {
