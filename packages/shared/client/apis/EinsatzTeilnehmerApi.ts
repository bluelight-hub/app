...
export class EinsatzTeilnehmerApi extends runtime.BaseAPI {
  ...
  async einsatzTeilnehmerControllerJoinEinsatzVAlphaRaw(
    ...
    if (requestParameters['joinEinsatzDto'] == null) {
      throw new runtime.RequiredError('joinEinsatzDto', 'Required parameter "joinEinsatzDto" was null or undefined when calling einsatzTeilnehmerControllerJoinEinsatzVAlpha().');
    }
