...
import type { ProfileControllerUpdateProfileV1200Response, UpdateProfileDto, UserControllerFindAllBasicVAlpha200Response, UserControllerFindOneVAlpha200Response } from '../models/index';
import {
...
export class UsersApi extends runtime.BaseAPI {
   ...
   */
  async profileControllerUpdateProfileV1Raw(
    requestParameters: ProfileControllerUpdateProfileV1Request,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<ProfileControllerUpdateProfileV1200Response>> {
    if (requestParameters['updateProfileDto'] == null) {
      throw new runtime.RequiredError('updateProfileDto', 'Required parameter "updateProfileDto" was null or undefined when calling profileControllerUpdateProfileV1().');
    }
   ...
   * Eigenes Profil aktualisieren (z.B. Eskalationsperson)
   */
  async profileControllerUpdateProfileV1(
    requestParameters: ProfileControllerUpdateProfileV1Request,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<ProfileControllerUpdateProfileV1200Response> {
