...
export class EinsatztagebuchApi extends runtime.BaseAPI {
  ...
  async etbControllerAddAttachmentV1Raw(
    ...
    if (requestParameters['beschreibung'] != null) {
      formParams.append('beschreibung', requestParameters['beschreibung'] as any);
    }
  ...
  async etbControllerAddAttachmentV1(
    ...
    const response = await this.etbControllerAddAttachmentV1Raw(requestParameters, initOverrides);
  ...
  async etbControllerCloseEntryV1(
    ...
    const response = await this.etbControllerCloseEntryV1Raw(requestParameters, initOverrides);
    return await response.value();
  }
  ...
  async etbControllerCreateV1(
    ...
    const response = await this.etbControllerCreateV1Raw(requestParameters, initOverrides);
    return await response.value();
  }
  ...
  async etbControllerFindAllV1Raw(
    ...
    if (requestParameters['referenzEinsatzId'] != null) {
      queryParameters['referenzEinsatzId'] = requestParameters['referenzEinsatzId'];
    }

    if (requestParameters['referenzPatientId'] != null) {
      queryParameters['referenzPatientId'] = requestParameters['referenzPatientId'];
    }

    if (requestParameters['referenzEinsatzmittelId'] != null) {
      queryParameters['referenzEinsatzmittelId'] = requestParameters['referenzEinsatzmittelId'];
    }
    ...
    if (requestParameters['includeUeberschrieben'] != null) {
      queryParameters['includeUeberschrieben'] = requestParameters['includeUeberschrieben'];
    }
  ...
  async etbControllerFindAllV1(
    ...
    const response = await this.etbControllerFindAllV1Raw(requestParameters, initOverrides);
    return await response.value();
  }
  ...
  async etbControllerFindAttachmentV1(
    ...
    const response = await this.etbControllerFindAttachmentV1Raw(requestParameters, initOverrides);
    return await response.value();
  }
  ...
  async etbControllerFindAttachmentsV1(
    ...
    const response = await this.etbControllerFindAttachmentsV1Raw(requestParameters, initOverrides);
    return await response.value();
  }
  ...
  async etbControllerFindOneV1(
    ...
    const response = await this.etbControllerFindOneV1Raw(requestParameters, initOverrides);
    return await response.value();
  }
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: UeberschreibeEtbDtoToJSON(requestParameters['ueberschreibeEtbDto']),
      },
      initOverrides,
    );
  ...
  async etbControllerUpdateV1(
    ...
    const response = await this.etbControllerUpdateV1Raw(requestParameters, initOverrides);
    return await response.value();
  }
}
