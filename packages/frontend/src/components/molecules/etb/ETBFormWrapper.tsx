...
export const ETBFormWrapper: React.FC<ETBFormWrapperProps> = ({ inputVisible, closeForm, children }) => {
  ...
  return (
    <div className="mt-4 p-4 border border-gray-200 rounded-md shadow-sm">
      <div className="flex justify-between items-center mb-2">
        ...
        <Button type="text" icon={<PiX />} onClick={closeForm} className="text-gray-500 hover:text-gray-700" />
      </div>
