...
export function LogoWithIndicator({ size = 'lg', showIndicator = true }: LogoWithIndicatorProps) {
  ...
  return (
    <div className="relative inline-block">
      ...
      {showIndicator && <div className="animate-pulse-shadow absolute -right-0.5 -top-0.5 h-4 w-4 rounded-full border-[3px] border-white bg-green-400 dark:border-gray-800" />}
    </div>
  );
}
