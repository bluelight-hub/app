  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        ...
        <p className="text-gray-600 mt-2">Konfigurieren Sie globale Systemeinstellungen und Parameter</p>
      </div>
      ...
      >
        <Tabs defaultActiveKey="general">
          <TabPane tab="Allgemein" key="general">
            <Card className="mb-4">
              ...
              <Form.Item name="maintenanceMode" label="Wartungsmodus" valuePropName="checked">
                <Switch />
              </Form.Item>
            </Card>
          </TabPane>
          ...
          >
            <Card className="mb-4">
              <Alert
                ...
                className="mb-4"
              />
              <Form.Item name="autoBackup" label="Automatische Sicherung" valuePropName="checked">
                <Switch />
              </Form.Item>
              <Form.Item
                name="backupInterval"
              ...
              <Space>
                <Button icon={<PiDatabase />}>Manuelle Sicherung starten</Button>
                <Button icon={<PiArrowClockwise />}>Datenbank optimieren</Button>
              </Space>
            </Card>
          </TabPane>
          ...
          >
            <Card className="mb-4">
              ...
              <Form.Item name="enableRegistration" label="Selbstregistrierung erlauben" valuePropName="checked">
                <Switch />
              </Form.Item>
              <Form.Item
          ...
          >
            <Card className="mb-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <Form.Item name="smtpSecure" label="Verschlüsselung (TLS/SSL)" valuePropName="checked">
                  <Switch />
                </Form.Item>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <Form.Item name="smtpUser" label="SMTP Benutzername">
                  <Input />
                </Form.Item>
                <Form.Item name="smtpPassword" label="SMTP Passwort">
                  <Input.Password />
                </Form.Item>
              </div>
              <Button icon={<PiEnvelope />}>Test-E-Mail senden</Button>
            </Card>
          </TabPane>
        ...
        <div className="flex gap-2 mt-6">
          <Button type="primary" htmlType="submit" icon={<PiFloppyDisk />} loading={loading}>
            Einstellungen speichern
          </Button>
          <Button icon={<PiArrowClockwise />} onClick={handleReset}>
            Zurücksetzen
          </Button>
        </div>
      </Form>
