...
const OrganizationsPage: React.FC = () => {
  ...
  const handleDelete = (_orgId: string) => {
    Modal.confirm({
      ...
      content:
        'Sind Sie sicher, dass Sie diese Organisation löschen möchten? Alle zugehörigen Benutzer verlieren ihre Zuordnung.',
      okText: 'Löschen',
      okType: 'danger',
  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        ...
        <p className="text-gray-600 mt-2">Verwalten Sie Organisationen und deren Strukturen</p>
      </div>
      ...
      >
        <Form form={form} layout="vertical">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <Form.Item name="type" label="Typ" rules={[{ required: true, message: 'Bitte Typ auswählen' }]}>
              <Select>
          ...
          <Form.Item name="address" label="Adresse" rules={[{ required: true, message: 'Bitte Adresse eingeben' }]}>
            <Input />
          </Form.Item>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <Form.Item
