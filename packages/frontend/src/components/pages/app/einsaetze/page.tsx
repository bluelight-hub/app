...
export const EinsaetzeUebersichtPage: React.FC = () => {
  ...
  const { searchText, debouncedSearchText, updateSearch, clearSearch } = useEinsatzSearch();
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <Card>
          <Table<Einsatz>
            ...
            locale={{
              emptyText: searchText ? 'Keine Einsätze entsprechen den Suchkriterien' : 'Keine Einsätze vorhanden',
            }}
            onRow={(record) => ({
