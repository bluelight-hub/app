  ...
  default: function MockAppLayout({ children }: { children?: React.ReactNode }) {
    ...
    return (
      <div data-testid="app-layout" className="min-h-screen bg-white dark:bg-gray-900">
        <div data-testid="sidebar" data-is-open={isMobileMenuOpen} data-is-mobile={isMobile} data-nav-items="1">
        ...
        <main className="py-10 lg:pl-72">
          <div className="px-4 sm:px-6 lg:px-8">{children || <div data-testid="outlet-content">Page Content</div>}</div>
        </main>
      </div>
    );
  },
...
vi.mock('../../config/navigation', () => ({
  ...
  mainNavigation: [{ name: 'Dashboard', href: '/dashboard', icon: 'DashboardIcon' }],
}));
