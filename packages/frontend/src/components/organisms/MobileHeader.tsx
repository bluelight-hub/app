 ...
 */
const MobileHeader: React.FC<MobileHeaderProps> = ({ title, onOpenSidebar }) => {
  ...
  return (
    <div className="sticky top-0 z-40 flex items-center gap-x-6 bg-white dark:bg-gray-900 px-4 py-4 shadow-sm dark:shadow-gray-800 sm:px-6 lg:hidden">
      <Button type="text" className="-m-2.5 p-2.5 text-gray-700 dark:text-gray-300 lg:hidden" onClick={onOpenSidebar}>
