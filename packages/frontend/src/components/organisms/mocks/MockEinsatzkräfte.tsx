...
const KraefteUebersicht: React.FC = () => {
                ...
                >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <Form.Item
                            label="Rolle"
                            name="role"
                            rules={[{ required: true, message: 'Bitte eine Rolle wählen' }]}
                        >
            ...
            return (
                <div className="p-2 text-sm text-gray-600">
                    <p className="mb-1">
                        ...
                        {record.ereignisse?.length
                            ? record.ereignisse.join(', ')
    ...
    const handleMassAction = () => {
        ...
        message.success(
            `${selectedRowKeys.length} Kräfte mit Massenaktion aktualisiert ✅`
        );
                ...
                <div className="grid grid-cols-3 gap-4 mb-4">
                    ...
                    <Card className="col-span-1 text-center shadow-sm">
                        ...
                        <span className="text-2xl font-bold">
                            {kraefte.filter((k) => k.status === 'eingesetzt').length}
                        </span>
                    </Card>
                    <Card className="col-span-1 text-center shadow-sm">
                        <span className="block text-gray-500 text-sm">Verfügbar</span>
                        <span className="text-2xl font-bold">
                            {kraefte.filter((k) => k.status === 'verfügbar').length}
                        </span>
                    </Card>
                </div>
