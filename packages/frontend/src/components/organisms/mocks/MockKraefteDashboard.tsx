            ...
            >
                <Form form={formKraft} layout="vertical">
                    ...
                    <Form.Item
                        label="Rolle"
                        name="role"
                        rules={[{ required: true, message: "Bitte Rolle wählen" }]}
                    >
                        <Select
                            options={[
                    ...
                    <Form.Item
                        label="Status"
                        name="status"
                        rules={[{ required: true, message: "Bitte Status wählen" }]}
                    >
                        <Radio.Group>
            ...
            >
                <Form form={formRolle} layout="vertical">
                    <Form.Item
                        label="Name"
                        name="name"
                        rules={[{ required: true, message: "Bitte einen Rollennamen eingeben" }]}
                    >
