...
const PatientsManage: React.FC = () => {
  ...
  return (
    <div style={{ padding: '1rem' }}>
      ...
      <Modal title="Betroffenen bearbeiten" visible={isModalOpen} onCancel={() => setIsModalOpen(false)} footer={null}>
        <Form form={form} layout="vertical" onFinish={handleSave}>
          <Form.Item label="Name" name="name" rules={[{ required: true, message: 'Name darf nicht leer sein.' }]}>
            <Input />
          </Form.Item>
