    ...
    return (
        <div className="pb-6">
            ...
            <Tabs
                defaultActiveKey="1"
                size="large"
                className="backlog-tabs"
                tabPosition="top"
            >
                {Object.entries(backlogGrouped).length === 0 ? (
                    <Empty image={Empty.PRESENTED_IMAGE_SIMPLE} description="Keine Checklisten gefunden. Bitte ändere deine Suchanfrage." />
                ) : (
        ...
        <Card
            ...
            title={
                <div className="flex justify-between items-center">
                    <Typography.Text strong className="mr-2 flex-1">{checklist.title}</Typography.Text>
                    <Progress
                        type="circle"
                        ...
                        >
                            <div className="flex items-start w-full gap-2">
                                ...
                                <div className="flex-1">
                                    <div className={`${isChecked ? 'line-through text-gray-500' : ''} break-words`}>
                                        {step.name}
                                    </div>
                                    {stepNote && (
...
const ChecklistsManager: React.FC = () => {
    ...
    const activateChecklist = useCallback((checklist: Checklist) => {
    ...
    // --------------- NOTIZEN HANDLING ---------------
    const openNoteModal = useCallback((checklistId: string, stepIndex: number) => {
    ...
    return (
        <div className="p-4">
            <Typography.Title level={2} className="mb-6">Checklisten-Manager</Typography.Title>
