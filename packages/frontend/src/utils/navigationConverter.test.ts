...
describe('navigationConverter', () => {
  ...
  it('should convert a group with items', () => {
    ...
    expect(groupItem.children[0]).toEqual(
      expect.objectContaining({
        key: '/item1',
        label: 'Item 1',
      }),
    );
    expect(groupItem.children[1]).toEqual(
      expect.objectContaining({
        key: '/item2',
        label: 'Item 2',
      }),
  ...
  it('should convert a submenu with items', () => {
    ...
    expect(submenuItem.children[0]).toEqual(
      expect.objectContaining({
        key: '/subitem1',
        label: 'Subitem 1',
      }),
    );
    expect(submenuItem.children[1]).toEqual(
      expect.objectContaining({
        key: '/subitem2',
        label: 'Subitem 2',
      }),
