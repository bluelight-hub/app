...
import { Badge } from '@/shared/ui/atoms/badge.atom'; /** * Zod-Schema für UpdateStammPerson Form. * Hinweis: personalnummer ist IMMUTABLE und kann nicht geändert werden. */
...
} /** * Dialog zum Bearbeiten einer Stamm-Person. * Hinweis: Personalnummer kann nicht geändert werden (IMMUTABLE). */
