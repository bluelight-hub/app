        ...
        <div className="rounded-lg bg-surface-panel p-4 shadow">
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-lg border border-border-subtle p-4">
              <div className="mb-3 h-4 w-52 animate-pulse rounded bg-surface-raised" />
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                <div className="space-y-2">
                  <div className="h-4 w-36 animate-pulse rounded bg-surface-raised" />
                  <div className="h-9 w-full animate-pulse rounded-lg bg-surface-raised" />
                </div>
                <div className="space-y-2">
                  <div className="h-4 w-36 animate-pulse rounded bg-surface-raised" />
                  <div className="h-9 w-full animate-pulse rounded-lg bg-surface-raised" />
            ...
            {/* Kontext */}
            <div className="rounded-lg border border-border-subtle p-4">
              <div className="mb-3 h-4 w-36 animate-pulse rounded bg-surface-raised" />
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                <div className="space-y-2">
            ...
            <div className="rounded-lg border border-border-subtle p-4">
              ...
              <div className="h-24 w-full animate-pulse rounded-lg bg-surface-raised" />
            </div>

            {/* Aktions-Buttons */}
            <div className="flex justify-end gap-3">
              <div className="h-9 w-28 animate-pulse rounded-md bg-surface-raised" />
              <div className="h-9 w-36 animate-pulse rounded-md bg-surface-raised" />
            </div>
          </div>
        </div>

        {/* Aktions-Hint */}
        <p className="text-center text-sm text-text-secondary">ETB wird geladen — bitte warten</p>
