...
import { PiAlarm, PiBellSimple, PiCheck, PiCheckCircle, PiClock, PiPencilSimple, PiTrash, PiUser, PiWarning, PiCircleNotch, PiListMagnifyingGlass } from 'react-icons/pi';

/**
 * Event-Type Konfiguration
 *
 * Definiert Icons, Farben und Labels fuer jeden Event-Typ.
 */
...
/**
 * Holt die Event-Konfiguration fuer einen Event-Typ
 */
