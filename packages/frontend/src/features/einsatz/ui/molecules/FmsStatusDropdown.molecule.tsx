  ...
  return (
    <Listbox as="div" value={value} onChange={onChange} disabled={disabled}>
      <div className={cn('relative', className)}>
        ...
        <ListboxOptions
          transition
          className="absolute z-10 mt-1 max-h-60 w-full overflow-auto rounded-md bg-surface-panel py-1 text-base shadow-panel ring-1 ring-border-subtle transition duration-100 ease-in focus-visible:outline-none data-[closed]:opacity-0 sm:text-sm"
        >
