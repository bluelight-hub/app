...
describe('useBrowserWarningDismissed', () => {
  ...
  let originalGetItem: typeof window.sessionStorage.getItem;
  let originalSetItem: typeof window.sessionStorage.setItem;
  ...
  beforeEach(() => {
    ...
    originalGetItem = window.sessionStorage.getItem.bind(window.sessionStorage);
    originalSetItem = window.sessionStorage.setItem.bind(window.sessionStorage);
  ...
  describe('Initial State', () => {
    ...
    it('should return isDismissed=true when sessionStorage has "true"', () => {
      ...
      window.sessionStorage.setItem('browser-security-warning-dismissed', 'true');
    ...
    it('should return isDismissed=false when sessionStorage has other value', () => {
      ...
      window.sessionStorage.setItem('browser-security-warning-dismissed', 'false');
    ...
    it('should return isDismissed=false when sessionStorage has empty string', () => {
      ...
      window.sessionStorage.setItem('browser-security-warning-dismissed', '');
  ...
  describe('dismiss() Function', () => {
    ...
    it('should write "true" to sessionStorage when dismiss() is called', () => {
      ...
      expect(window.sessionStorage.getItem('browser-security-warning-dismissed')).toBe('true');
    });
  ...
  describe('Error Handling', () => {
    it('should handle sessionStorage.getItem errors gracefully', () => {
      ...
      window.sessionStorage.getItem = vi.fn(() => {
  ...
  describe('Private Browsing Memory Fallback', () => {
    ...
    it('should set memory fallback when dismiss() is called and setItem throws', () => {
      ...
      window.sessionStorage.getItem = getItemMock;
  ...
  describe('Persistence Across Component Mounts', () => {
    ...
    it('should NOT persist across page reloads (sessionStorage vs localStorage)', () => {
      ...
      expect(window.sessionStorage.getItem('browser-security-warning-dismissed')).toBe('true');
      expect(window.localStorage.getItem('browser-security-warning-dismissed')).toBeNull();
    });
  });
