...
/**
 * Listen-/Filter-Route `/app/einsatz/$einsatzId/sicherheit/eigenschutz/vorfaelle/`
 * (Story 5.1, T5.5; Story 5.3 erweitert um `validateSearch` für Deep-Link-
 * fähige Filter).
 *
 * Liegt unter der Layout-Route `../vorfaelle.tsx`, damit Detail-Klicks der
 * Liste die Geschwister-Route `./$vorfallId.tsx` (Story 5.2) im
 * `<Outlet />` der Layout-Route anzeigen können.
 *
...
export const Route = createFileRoute('/app/einsatz/$einsatzId/sicherheit/eigenschutz/vorfaelle/')({
  ...
  component: VorfaelleIndexRouteComponent,
});

function VorfaelleIndexRouteComponent() {
