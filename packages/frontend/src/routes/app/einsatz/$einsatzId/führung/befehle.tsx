...
function BefehleSeite() {
  ...
  return (
    <div className="flex h-full flex-col">
      ...
      {/* Error-State */}
      {isError && (
        <div className="bg-status-danger-surface px-4 py-2 text-sm text-status-danger-text">
        ...
        {hasFilters && aktiveBefehle?.length === 0 && !isError ? (
          <div className="flex flex-1 flex-col items-center justify-center py-16 text-center">
            ...
            <button
              ...
              className="mt-2 text-sm text-primary-600 hover:text-primary-700 focus:outline-none focus-visible:shadow-focus-ring dark:text-primary-400 dark:hover:text-primary-300"
            >
              Filter zurücksetzen
            </button>
          </div>
