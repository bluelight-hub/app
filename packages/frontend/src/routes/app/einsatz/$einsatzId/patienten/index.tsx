...
function PatientenComponent() {
  ...
  return (
    <div className="space-y-4">
      <div>
        <h1 className="text-2xl font-bold text-text-primary">Patientenübersicht</h1>
        <p className="mt-1 text-sm text-text-muted">Verwaltung aller Patienten im Einsatz</p>
      </div>
